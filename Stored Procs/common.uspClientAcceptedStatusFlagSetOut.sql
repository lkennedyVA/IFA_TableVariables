USE [IFA]
GO
/****** Object:  StoredProcedure [common].[uspClientAcceptedStatusFlagSetOut]    Script Date: 1/2/2025 7:43:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/****************************************************************************************
	Name: uspClientAcceptedStatusFlagSetOut
	CreatedBy: Larry Dugger
	Date: 2015-08-04
	Descr: This procedure will Activate the ClientAccepted (Set StatusFlag)
...
*****************************************************************************************/
ALTER PROCEDURE [common].[uspClientAcceptedStatusFlagSetOut](
