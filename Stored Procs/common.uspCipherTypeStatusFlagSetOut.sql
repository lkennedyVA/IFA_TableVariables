USE [IFA]
GO
/****** Object:  StoredProcedure [common].[uspCipherTypeStatusFlagSetOut]    Script Date: 1/2/2025 7:42:28 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/****************************************************************************************
	Name: uspCipherTypeStatusFlagSetOut
	CreatedBy: Larry Dugger
	Date: 2015-05-07
	Description: This procedure will Activate the CipherType record
...
*****************************************************************************************/
ALTER PROCEDURE [common].[uspCipherTypeStatusFlagSetOut](
