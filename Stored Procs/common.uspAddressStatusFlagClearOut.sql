USE [IFA]
GO
/****** Object:  StoredProcedure [common].[uspAddressStatusFlagClearOut]    Script Date: 1/2/2025 6:12:07 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/****************************************************************************************
	Name: uspAddressStatusFlagClearOut
	CreatedBy: Larry Dugger
	Date: 2015-05-07
	Descr: This procedure will DeActivate the Address (Clear StatusFlag)
...
*****************************************************************************************/
ALTER PROCEDURE [common].[uspAddressStatusFlagClearOut](
