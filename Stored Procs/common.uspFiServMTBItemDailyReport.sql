...
GO
/****************************************************************************************
	Name: uspFiServMTBItemDailyReport
...
BEGIN
	SET NOCOUNT ON;
	drop table if exists #FiServMTBItemDaily
	CREATE TABLE #FiServMTBItemDaily(
		 LevelId int
		,ParentId int
	...
	INSERT INTO #FiServMTBItemDaily(LevelId,ParentId,OrgId,OrgCode,OrgName,ExternalCode,TypeId,[Type],StatusFlag,DateActivated,ChannelName)
	...
	INNER JOIN #FiServMTBItemDaily dol ON p.OrgId = dol.OrgId
