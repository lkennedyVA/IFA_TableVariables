USE [IFA]
GO
/****** Object:  StoredProcedure [common].[uspDimensionStatusFlagClearOut]    Script Date: 1/2/2025 8:16:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/****************************************************************************************
	Name: uspDimensionStatusFlagClearOut
	CreatedBy: Larry Dugger
	Date: 2015-05-07
	Descr: This procedure will DeActivate the Dimension (Clear StatusFlag)
...
*****************************************************************************************/
ALTER PROCEDURE [common].[uspDimensionStatusFlagClearOut](
