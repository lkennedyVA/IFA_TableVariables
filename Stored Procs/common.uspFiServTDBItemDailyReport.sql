USE [IFA]
GO
/****** Object:  StoredProcedure [common].[uspFiServTDBItemDailyReport]    Script Date: 2/18/2025 9:54:28 AM ******/
SET ANSI_NULLS ON
GO
...
/****************************************************************************************
    Name: [common].[uspFiServTDBItemDailyReport]
...
END;
    ...
    DROP TABLE IF EXISTS #FiServItemDailyReportTDB;
    DROP TABLE IF EXISTS #tblFiServDetailTDB;

    -- Create temp table for hierarchical organization data
    CREATE TABLE #FiServItemDailyReportTDB (
        LevelId INT,
        ParentId INT,
    ...
    CREATE TABLE #tblFiServDetailTDB (
    ...
    INSERT INTO #FiServItemDailyReportTDB (LevelId, ParentId, OrgId, OrgCode, OrgName, ExternalCode, TypeId, [Type], StatusFlag, DateActivated, ChannelName)
    SELECT 
    ...
    INSERT INTO #tblFiServDetailTDB (
    ...
    INNER JOIN #FiServItemDailyReportTDB dol ON p.OrgId = dol.OrgId
