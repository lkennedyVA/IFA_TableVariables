USE [IFA]
GO
/****** Object:  StoredProcedure [common].[uspItemTypeStatusFlagSetOut]    Script Date: 1/2/2025 9:46:59 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/****************************************************************************************
	Name: uspItemTypeStatusFlagSetOut
	CreatedBy: Larry Dugger
	Date: 2015-05-07
	Description: This procedure will Activate the ItemType record
...
*****************************************************************************************/
ALTER PROCEDURE [common].[uspItemTypeStatusFlagSetOut](
