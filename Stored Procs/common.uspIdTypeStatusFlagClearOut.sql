USE [IFA]
GO
/****** Object:  StoredProcedure [common].[uspIdTypeStatusFlagClearOut]    Script Date: 1/2/2025 9:21:18 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/****************************************************************************************
	Name: uspIdTypeStatusFlagClearOut
	CreatedBy: Larry Dugger
	Date: 2015-05-07
	Description: This procedure will Deactivate the IdType record
...
*****************************************************************************************/
ALTER PROCEDURE [common].[uspIdTypeStatusFlagClearOut](
