...
GO
/****************************************************************************************
	Name: uspFiServFNBPAItemDailyReport
	CreatedBy: Larry Dugger
	Description: This procedure reports on FNB Item activity for the date range.
...
BEGIN
	SET NOCOUNT ON;
	drop table if exists #FiServFNBPAItemDaily;
	CREATE TABLE #FiServFNBPAItemDaily (
		 LevelId int
		,ParentId int
	...
	INSERT INTO #FiServFNBPAItemDaily(LevelId,ParentId,OrgId,OrgCode,OrgName,ExternalCode,TypeId,[Type],StatusFlag,DateActivated,ChannelName)
	...
	INNER JOIN #FiServFNBPAItemDaily dol ON p.OrgId = dol.OrgId
