USE [IFA]
GO
/****** Object:  StoredProcedure [common].[uspAddressStatusFlagNeverActiveOut]    Script Date: 1/2/2025 6:12:43 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/****************************************************************************************
	Name: uspAddressStatusFlagNeverActiveOut
	CreatedBy: Larry Dugger
	Date: 2015-05-07
	Descr: This procedure will Invalidate the Address (Set StatusFlag to NeverActive)
...
*****************************************************************************************/
ALTER PROCEDURE [common].[uspAddressStatusFlagNeverActiveOut](
