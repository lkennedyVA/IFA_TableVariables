USE [IFA]
GO
/****** Object:  StoredProcedure [common].[uspFlowOptionStatusFlagSetOut]    Script Date: 1/2/2025 9:19:04 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/****************************************************************************************
	Name: uspFlowOptionStatusFlagSetOut
	CreatedBy: Larry Dugger
	Date: 2015-05-07
	Description: This procedure will Activate the FlowOption record
...
*****************************************************************************************/
ALTER PROCEDURE [common].[uspFlowOptionStatusFlagSetOut](
