USE [IFA]
GO
/****** Object:  StoredProcedure [common].[uspAccountTypeStatusFlagClearOut]    Script Date: 1/2/2025 6:10:23 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/****************************************************************************************
	Name: uspAccountTypeStatusFlagClearOut
	CreatedBy: Larry Dugger
	Date: 2015-05-07
	Description: This procedure will Deactivate the AccountType record
...
*****************************************************************************************/
ALTER PROCEDURE [common].[uspAccountTypeStatusFlagClearOut](
